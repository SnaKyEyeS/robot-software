...
# Generate a test exec given test sources and their dependencies Called like cvra_add_test(TARGET
# foo_test SOURCES foo_test.cpp DEPENDENCIES foo_lib)
function(cvra_add_test)
    set(options)
    set(oneValueArgs TARGET)
    set(multiValueArgs SOURCES DEPENDENCIES)
    cmake_parse_arguments(
        TEST_EXECUTABLE "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN}
    )
